        ...
        <form method="post" action="<?php echo esc_url(admin_url('options.php')); ?>">
            ...
            <div class="iaf-head">
                ...
                <div class="iaf-head-meta">
                    ...
                    <a class="iaf-docs" href="https://ibracodes.com/resources/%d7%aa%d7%95%d7%a1%d7%a3-avif-%d7%9c%d7%95%d7%95%d7%a8%d7%93%d7%a4%d7%a8%d7%a1/" target="_blank" rel="noopener"><?php esc_html_e('Documentation', 'ibracodes-avif-converter'); ?></a>
                </div>
            </div>
                ...
                <div class="iaf-card">
                    <label class="iaf-row iaf-flip">
                        <span class="iaf-row-copy">
                            ...
                            <span class="iaf-row-help"><?php esc_html_e('Image sizes are written in the modern format. Your uploaded file is kept untouched as the original, so alt text, captions and social-preview scrapers are unaffected.', 'ibracodes-avif-converter'); ?></span>
                        </span>
                ...
                <div class="iaf-card iaf-pad">
                    ...
                    <div class="iaf-totals">
                        <span data-iaf-rewritten data-template="<?php
                            ...
                            esc_attr_e('URLs updated: %d', 'ibracodes-avif-converter'); ?>"><?php printf(
